...
### 5.5 Post-Publication Spec-Volume Reduction Tranche Markers (Issue #5729)

Post-publication tranche-6 removed 14 additional low-value archived issue-spec pairs (pointer +
archive payload) and reduced top-level `specs/` directory count from `785` to `771`.

- r52_review_post_publication_spec_volume_reduction_schema_version=kamn.review.spec-volume-post-publication-reduction.v1
- r52_review_spec_volume_reduction_tranche_pre_count=785
- r52_review_spec_volume_reduction_tranche_deleted_count=14
- r52_review_spec_volume_reduction_tranche_post_count=771
