...
- The framework extraction pilot keeps legacy shell command surfaces stable while
  ...
  - migrated lanes: token launch handoff, treasury disbursement approvals, post-cutover SLO canary gate, escrow settlement reconciliation, cutover rollback evidence, federated delegation settlement, SOC2 control evidence, DSAR legal-hold, governance simulation, governance stake/slash, reputation dispute, reputation signal quarantine, reputation recovery reversal.
