...
- Task (current wave): `#5285` — start Phase-6 retention-to-archival gate execution contracts
...
- `#5285`: in progress in this wave (Phase-6 retention-to-archival gate execution kickoff).
