use kamn_data_layer::data_layer_m10_phase6_runtime_evidence::{
    data_layer_m10_project_phase6_runtime_evidence_bundle, DataLayerM10Phase6PolicyArchivedEntry,
    DataLayerM10Phase6PolicyBudgetDecision, DataLayerM10Phase6PolicyCycleReport,
    DataLayerM10Phase6PolicyExecutionReport, DataLayerM10Phase6PolicyRuntimeEvidenceBundle,
                    ...
                    execution_report: Some(DataLayerM10Phase6PolicyExecutionReport {
                        ...
                        archived_entries: vec![
                            DataLayerM10Phase6PolicyArchivedEntry {
                                ...
                                archived_object_uri:
                                    "s3://kamn-archive/messages/messages_2024_02.parquet.zst"
                                        .to_owned(),
                            },
                            DataLayerM10Phase6PolicyArchivedEntry {
                                ...
                                archived_object_uri:
                                    "s3://kamn-archive/messages/messages_2024_01.parquet.zst"
                                        .to_owned(),
                            },
                        ],
                    }),
