...
#[test]
fn integration_scheduler_defers_when_count_and_window_thresholds_are_not_met() {
...
#[test]
fn integration_scheduler_triggers_deterministically_for_count_and_window_thresholds() {
    let now = 1_900_000_000;
...
#[test]
fn integration_scheduler_fails_closed_for_invalid_policy_or_pending_inputs() {
