...
const ROOT: &str = "tests/stdio_protocol_contract.rs";
const ROOT_BUDGET: usize = 180;
const REQUIRED_MODULE_MARKERS: &[&str] = &[
    "#[path = \"stdio_protocol_contract/support.rs\"]",
    "#[path = \"stdio_protocol_contract/initialize_inventory_contract_tests.rs\"]",
    "#[path = \"stdio_protocol_contract/tool_dispatch_contract_tests.rs\"]",
    "#[path = \"stdio_protocol_contract/error_compat_contract_tests.rs\"]",
];
const REQUIRED_FILES: &[&str] = &[
    "tests/stdio_protocol_contract/support.rs",
    "tests/stdio_protocol_contract/initialize_inventory_contract_tests.rs",
    "tests/stdio_protocol_contract/tool_dispatch_contract_tests.rs",
    "tests/stdio_protocol_contract/error_compat_contract_tests.rs",
];
