...
const ROUTE_BRIDGE_PREFIX: &str = "/v1/bridge/";
const ROUTE_BRIDGE_FORWARD_SUFFIX: &str = "/forward";
...
const REASON_CODE_RELAY_DID_INVALID: &str = "service_api_relay_did_invalid";
...
pub(crate) const SERVICE_API_ROUTE_AUTHZ_MATRIX_TOTAL_ROUTE_COUNT: usize = 21;
pub(crate) const SERVICE_API_ROUTE_AUTHZ_MATRIX_PUBLIC_ROUTE_COUNT: usize = 2;
pub(crate) const SERVICE_API_ROUTE_AUTHZ_MATRIX_PROTECTED_ROUTE_COUNT: usize = 19;
...
pub(crate) fn build_service_api_snapshot(report: &NodeBootstrapReport) -> ServiceApiSnapshot {
    ...
    ServiceApiSnapshot {
        ...
        scope_policy_fixture_unique_allow_route_count: scope_policy_fixture_projection
        ...
        scope_policy_fixture_unique_allow_only_route_count: scope_policy_fixture_projection
            .unique_allow_only_route_count,
        scope_policy_fixture_unique_deny_only_route_count: scope_policy_fixture_projection
            .unique_deny_only_route_count,
        ...
        scope_policy_fixture_unique_allow_deny_overlap_method_count:
            scope_policy_fixture_projection.unique_allow_deny_overlap_method_count,
        scope_policy_fixture_unique_allow_only_method_count: scope_policy_fixture_projection
            .unique_allow_only_method_count,
        scope_policy_fixture_unique_deny_only_method_count: scope_policy_fixture_projection
            .unique_deny_only_method_count,
