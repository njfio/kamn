...
#[test]
fn functional_live_postgres_topology_host_mode_host_pair_cardinality_rows_are_canonical() {
    ...
    assert_topology_rows_match(
        collect_parallel_lane_topology_id_host_mode_host_pair_cardinality_rows(
