...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_COUNT_COHERENCE_CONTRACT: &str =
    "topology_id_to_host_mode_host_pair_lane_set_lane_count_rows_must_remain_stable_under_repeated_runs_and_permutations";
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_ID_BUNDLE_COHERENCE_SCHEMA_VERSION: &str =
    "kamn.runtime.daemon.phase6-live-postgres.parallel-lane-topology-host-mode-host-pair-lane-set-lane-id-bundle-coherence.v1";
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_ID_BUNDLE_COHERENCE_ROWS_CSV: &str =
...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_ID_BUNDLE_COHERENCE_CONTRACT: &str =
    "topology_id_to_host_mode_host_pair_lane_set_lane_id_bundle_rows_must_remain_stable_under_repeated_runs_and_permutations";
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_BUNDLE_COHERENCE_SCHEMA_VERSION: &str =
...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_BUNDLE_COHERENCE_ROWS_CSV: &str =
...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_HASH_ORDER_NORMALIZATION_SCHEMA_VERSION: &str =
...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_HASH_ORDER_NORMALIZATION_ROWS_CSV: &str =
    "distributed_label_parallel->distributed_label->node_alpha->node_beta->asymmetric_parallel->18ce08940c67c38e,same_host_parallel->same_host->node_alpha->node_alpha->symmetric_parallel->37e351d41d1e30ea";
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_HASH_ORDER_NORMALIZATION_CONTRACT: &str =
...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_HASH_ORDER_NORMALIZATION_DIGEST_SCHEMA_VERSION: &str =
...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_HASH_ORDER_NORMALIZATION_DIGEST_ROWS_CSV: &str =
    "distributed_label_parallel->distributed_label->node_alpha->node_beta->asymmetric_parallel->18ce08940c67c38e,same_host_parallel->same_host->node_alpha->node_alpha->symmetric_parallel->37e351d41d1e30ea";
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_HASH_ORDER_NORMALIZATION_DIGEST_ROWS_FNV1A64_HEX: &str =
    "25b9729eaeb44fe9";
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_HOST_MODE_HOST_PAIR_LANE_SET_LANE_FINGERPRINT_HASH_ORDER_NORMALIZATION_DIGEST_CONTRACT: &str =
...
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_LANE_ID_BUNDLE_DELIMITER: char = '+';
const LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_LANE_FINGERPRINT_BUNDLE_DELIMITER: char = '+';
...
fn extract_parallel_lane_topology_id_host_pair_row(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn extract_parallel_lane_topology_id_lane_set_row(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn extract_parallel_lane_topology_id_lane_count_row(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn extract_parallel_lane_topology_id_host_mode_row(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn extract_parallel_lane_topology_id_host_cardinality_row(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn extract_parallel_lane_topology_id_host_mode_cardinality_row(
...
fn extract_parallel_lane_topology_id_host_pair_cardinality_row(
    topology_fingerprint: &str,
) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
...
fn extract_parallel_lane_topology_id_host_mode_host_pair_row(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn extract_parallel_lane_topology_id_host_mode_host_pair_cardinality_row(
    topology_fingerprint: &str,
) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
...
fn extract_parallel_lane_topology_id_host_mode_host_pair_lane_set_lane_count_row(
    topology_fingerprint: &str,
) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
...
fn extract_parallel_lane_topology_lane_id_bundle(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn extract_parallel_lane_topology_id_host_mode_host_pair_lane_set_lane_id_bundle_row(
    topology_fingerprint: &str,
) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
...
fn extract_parallel_lane_topology_lane_fingerprint_bundle(topology_fingerprint: &str) -> String {
    let fields = parse_parallel_lane_topology_fingerprint_fields(topology_fingerprint);
    assert_eq!(
        fields.len(),
        LIVE_POSTGRES_PARALLEL_LANE_TOPOLOGY_FINGERPRINT_FIELD_COUNT,
...
fn collect_parallel_lane_topology_id_host_pair_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
...
fn collect_parallel_lane_topology_id_lane_set_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_lane_count_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_mode_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_cardinality_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_mode_cardinality_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_pair_cardinality_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_mode_host_pair_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_mode_host_pair_cardinality_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_mode_host_pair_lane_set_lane_count_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_mode_host_pair_lane_set_lane_id_bundle_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn collect_parallel_lane_topology_id_host_mode_host_pair_lane_set_lane_fingerprint_bundle_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let mut rows = run_parallel_lane_topology_fingerprints(topology_profiles)
        .iter()
...
fn assert_parallel_lane_topology_rows_are_canonically_sorted(rows: &[String], context: &str) {
...
fn collect_parallel_lane_topology_id_host_mode_host_pair_lane_set_lane_fingerprint_hash_order_normalized_rows(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> Vec<String> {
    let rows =
...
fn project_parallel_lane_topology_id_host_mode_host_pair_lane_set_lane_fingerprint_hash_order_normalization_digest(
    topology_profiles: Vec<LivePostgresParallelLaneTopologyProfile>,
) -> (Vec<String>, String) {
    let rows =
