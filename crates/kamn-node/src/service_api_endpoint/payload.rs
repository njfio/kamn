...
pub(super) fn render_service_api_endpoint_response(
    ...
    if method == "GET" && path == ROUTE_METRICS {
        ...
        let metrics = format!(
            ...
            snapshot.scope_policy_fixture_unique_allow_route_count,
            snapshot.scope_policy_fixture_unique_deny_route_count,
            snapshot.scope_policy_fixture_unique_allow_deny_overlap_route_count,
            snapshot.scope_policy_fixture_unique_allow_only_route_count,
            snapshot.scope_policy_fixture_unique_deny_only_route_count,
            snapshot.scope_policy_fixture_unique_allow_scope_count,
            snapshot.scope_policy_fixture_unique_deny_scope_count,
            snapshot.scope_policy_fixture_unique_allow_deny_overlap_scope_count,
            snapshot.scope_policy_fixture_unique_allow_only_scope_count,
            snapshot.scope_policy_fixture_unique_deny_only_scope_count,
            snapshot.scope_policy_fixture_unique_allow_deny_overlap_method_count,
            snapshot.scope_policy_fixture_unique_allow_only_method_count,
            snapshot.scope_policy_fixture_unique_deny_only_method_count,
            ...
            snapshot.relay_created_message_count,
            snapshot.relay_relayed_message_count,
            snapshot.relay_delivered_message_count,
            snapshot.relay_drained_count,
            snapshot.relay_projected_state_count,
