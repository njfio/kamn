...
const ROOT: &str = "tests/memory_agent.rs";
const ROOT_BUDGET: usize = 180;
const REQUIRED_MODULE_MARKERS: &[&str] = &[
    "#[path = \"memory_agent/identity_message_contract_tests.rs\"]",
    "#[path = \"memory_agent/task_escrow_contract_tests.rs\"]",
    "#[path = \"memory_agent/artifact_lifecycle_contract_tests.rs\"]",
    "#[path = \"memory_agent/query_validation_contract_tests.rs\"]",
];
const REQUIRED_FILES: &[&str] = &[
    "tests/memory_agent/identity_message_contract_tests.rs",
    "tests/memory_agent/task_escrow_contract_tests.rs",
    "tests/memory_agent/artifact_lifecycle_contract_tests.rs",
    "tests/memory_agent/query_validation_contract_tests.rs",
];

#[test]
fn memory_agent_root_is_extracted() {
    let source = fs::read_to_string(ROOT).expect("root memory-agent test file should be readable");
