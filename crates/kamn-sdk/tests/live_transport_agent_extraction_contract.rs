...
const ROOT: &str = "crates/kamn-sdk/tests/live_transport_agent.rs";
...
const REQUIRED_FILES: &[&str] = &[
    "crates/kamn-sdk/tests/live_transport_agent/support.rs",
    "crates/kamn-sdk/tests/live_transport_agent/transport_mode_contract_tests.rs",
    "crates/kamn-sdk/tests/live_transport_agent/message_contract_tests.rs",
    "crates/kamn-sdk/tests/live_transport_agent/resolve_profile_contract_tests.rs",
    "crates/kamn-sdk/tests/live_transport_agent/registration_search_contract_tests.rs",
    "crates/kamn-sdk/tests/live_transport_agent/channel_contract_tests.rs",
];
