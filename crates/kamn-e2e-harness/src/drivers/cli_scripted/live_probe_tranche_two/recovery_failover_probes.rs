use super::{
    agent_name, default_endpoint, env_payload, DEFAULT_S08_AGENT_NAME,
    DEFAULT_S08_POST_MESSAGE_PAYLOAD, DEFAULT_S08_PRE_MESSAGE_PAYLOAD, DEFAULT_S09_AGENT_NAME,
    DEFAULT_S09_POST_MESSAGE_PAYLOAD, DEFAULT_S09_PRE_MESSAGE_PAYLOAD,
};
...
pub(super) fn run_live_s08_cli_crash_recovery_probe() -> Result<(), String> {
    crash_recovery_probe::run_live_s08_cli_crash_recovery_probe()
}

pub(super) fn run_live_s09_cli_transport_failover_probe() -> Result<(), String> {
    transport_failover_probe::run_live_s09_cli_transport_failover_probe()
}
...
pub(super) fn s08_settings() -> S08Settings {
    S08Settings {
        ...
        base_agent_name: agent_name("KAMN_E2E_S08_AGENT_NAME", DEFAULT_S08_AGENT_NAME),
        pre_message_payload: env_payload(
            "KAMN_E2E_S08_PRE_MESSAGE_PAYLOAD",
            DEFAULT_S08_PRE_MESSAGE_PAYLOAD,
        ),
        post_message_payload: env_payload(
...
pub(super) fn s09_settings() -> S09Settings {
    ...
    S09Settings {
        ...
        base_agent_name: agent_name("KAMN_E2E_S09_AGENT_NAME", DEFAULT_S09_AGENT_NAME),
        pre_message_payload: env_payload(
