use super::{agent_name, env_payload, DEFAULT_S10_AGENT_NAME, DEFAULT_S10_MESSAGE_PAYLOAD};
...
fn s10_settings() -> S10Settings {
    ...
    S10Settings {
        ...
        base_agent_name: agent_name("KAMN_E2E_S10_AGENT_NAME", DEFAULT_S10_AGENT_NAME),
        message_payload: env_payload("KAMN_E2E_S10_MESSAGE_PAYLOAD", DEFAULT_S10_MESSAGE_PAYLOAD),
        primary_endpoint,
        secondary_endpoint,
    }
}
