...
#[test]
fn spec_c01_verifier_accepts_standalone_devnet_settlement_claim() {
    verify_mvp_demo_report_json(devnet_report_without_three_agent_claim())
        .expect("standalone devnet settlement must not imply three-agent verification");
}
