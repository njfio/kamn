...
fn spec_c03_verifier_rejects_verifier_private_context_leak() {
    let report =
        valid_three_agent_report().replace(r#""verifier_private_view_visible":false"#, r#""verifier_private_view_visible":true"#);
...
fn spec_c04_verifier_rejects_mismatched_shared_commitment() {
    let report =
        valid_three_agent_report().replace(r#""verifier_terms_digest":"terms-digest-7045""#, r#""verifier_terms_digest":"terms-digest-mismatch""#);
    let err = verify_mvp_demo_report_json(report)
