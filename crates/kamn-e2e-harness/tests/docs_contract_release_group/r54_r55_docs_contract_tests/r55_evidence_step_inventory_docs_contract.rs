...
release_doc_contract_tests!(
    ...
    ["r55_evidence_step_inventory_status_before=single-step", "r55_evidence_step_inventory_contract=implemented", "r55_evidence_step_inventory_status_after=active"],
