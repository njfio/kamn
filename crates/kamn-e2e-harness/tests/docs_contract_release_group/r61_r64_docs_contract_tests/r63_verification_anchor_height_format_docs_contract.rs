...
release_doc_contract_tests!(
    ...
    ["r63_verification_anchor_height_format_contract_status_before=missing", "r63_verify_anchor_block_height_format_enforcement=implemented", "r63_verification_anchor_height_format_contract_status_after=implemented"],
