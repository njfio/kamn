...
release_doc_contract_tests!(
    ...
    ["r64_verification_captured_at_format_contract_status_before=missing", "r64_verify_captured_at_format_enforcement=implemented", "r64_verification_captured_at_format_contract_status_after=implemented"],
