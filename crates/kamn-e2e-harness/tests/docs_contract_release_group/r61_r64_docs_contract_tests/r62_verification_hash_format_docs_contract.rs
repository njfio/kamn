...
release_doc_contract_tests!(
    ...
    ["r62_verification_hash_format_contract_status_before=missing", "r62_verify_artifact_hash_format_enforcement=implemented", "r62_verification_hash_format_contract_status_after=implemented"],
