...
release_doc_contract_tests!(
    ...
    ["r57_evidence_verification_block_contract_status_before=missing", "r57_verify_artifact_verification_marker_enforcement=implemented", "r57_evidence_verification_block_contract_status_after=implemented"],
