...
release_doc_contract_tests!(
    ...
    ["r59_chain_hash_continuity_contract_status_before=missing", "r59_verify_chain_hash_continuity_enforcement=implemented", "r59_chain_hash_continuity_contract_status_after=implemented"],
