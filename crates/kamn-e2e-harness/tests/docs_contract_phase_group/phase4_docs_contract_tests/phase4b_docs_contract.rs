...
phase_doc_contract_tests!(
    ...
    ["phase4b_status_before=partial", "phase4b_run_command_contract=implemented", "phase4b_verify_command_contract=implemented", "phase4b_scenario_csv_validation=implemented", "phase4b_verify_output_contract=implemented", "phase4b_status_after=implemented"],
