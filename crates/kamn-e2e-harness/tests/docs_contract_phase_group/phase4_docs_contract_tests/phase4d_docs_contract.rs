...
phase_doc_contract_tests!(
    ...
    ["phase4d_status_before=partial", "phase4d_phase_result_model=implemented", "phase4d_infra_and_agent_placeholders=implemented", "phase4d_status_after=implemented"],
