...
phase_doc_contract_tests!(
    ...
    ["phase4c_status_before=partial", "phase4c_orchestration_phase_model=implemented", "phase4c_phase_progression_markers=implemented", "phase4c_status_after=implemented"],
