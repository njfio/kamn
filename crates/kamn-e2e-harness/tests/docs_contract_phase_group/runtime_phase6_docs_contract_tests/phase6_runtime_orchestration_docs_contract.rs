...
phase_doc_contract_tests!(
    ...
    ["phase6_runtime_orchestration_status_before=partial", "phase6_runtime_orchestration_contract=implemented", "phase6_runtime_orchestration_status_after=implemented"],
