...
const ROOT: &str = "tests/docs_contract_phase_group.rs";
const ROOT_BUDGET: usize = 180;
const REQUIRED_MODULE_MARKERS: &[&str] = &[
    "#[path = \"docs_contract_phase_group/phase4_docs_contract_tests.rs\"]",
    "#[path = \"docs_contract_phase_group/phase5_docs_contract_tests.rs\"]",
    "#[path = \"docs_contract_phase_group/runtime_phase6_docs_contract_tests.rs\"]",
    "#[path = \"docs_contract_phase_group/phase6_docs_contract_tests.rs\"]",
    "#[path = \"docs_contract_phase_group/structure_docs_contract_tests.rs\"]",
];
const REQUIRED_FILES: &[&str] = &[
    "tests/docs_contract_phase_group/phase4_docs_contract_tests.rs",
    "tests/docs_contract_phase_group/phase5_docs_contract_tests.rs",
    "tests/docs_contract_phase_group/runtime_phase6_docs_contract_tests.rs",
    "tests/docs_contract_phase_group/phase6_docs_contract_tests.rs",
    "tests/docs_contract_phase_group/structure_docs_contract_tests.rs",
];

#[test]
fn docs_contract_phase_group_root_is_extracted() {
