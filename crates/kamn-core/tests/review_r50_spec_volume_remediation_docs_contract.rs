...
fn functional_r50_spec_volume_remediation_markers_present() {
    ...
    assert!(DOC.contains("r50_review_spec_volume_non_regression_baseline_spec_dirs=823"));
    ...
    assert!(DOC.contains("r50_review_spec_volume_non_regression_spec_dir_max=823"));
    assert!(DOC.contains(
