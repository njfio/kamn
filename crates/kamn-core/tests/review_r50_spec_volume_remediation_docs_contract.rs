...
fn functional_r50_spec_volume_remediation_markers_present() {
    ...
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_baseline_spec_dirs=823"));
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_baseline_module_count=92"));
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_ratio_max=9.0"));
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_spec_dir_max=823"));
    assert!(DOC_R50.contains(
...
fn functional_r52_post_publication_spec_volume_reduction_markers_present() {
    ...
    assert!(DOC_R52.contains("r52_review_spec_volume_reduction_tranche_pre_count=837"));
    assert!(DOC_R52.contains("r52_review_spec_volume_reduction_tranche_deleted_count=14"));
    assert!(DOC_R52.contains("r52_review_spec_volume_reduction_tranche_post_count=823"));
    assert!(DOC_R52
...
fn integration_r52_post_publication_spec_volume_reduction_markers_are_consistent() {
    ...
    assert_eq!(pre, 837, "tranche-2 pre-count marker should remain fixed");
    assert_eq!(
        deleted, 14,
        "tranche-2 deleted-count marker should remain fixed"
    );
    assert_eq!(
    ...
    assert_eq!(post, 823, "tranche-2 post-count marker should remain fixed");
    assert_eq!(
