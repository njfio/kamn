...
fn functional_r50_spec_volume_remediation_markers_present() {
    ...
    assert!(DOC.contains("r50_review_spec_volume_non_regression_baseline_spec_dirs=840"));
    assert!(DOC.contains("r50_review_spec_volume_non_regression_baseline_module_count=92"));
    assert!(DOC.contains("r50_review_spec_volume_non_regression_ratio_max=9.2"));
    assert!(DOC.contains("r50_review_spec_volume_non_regression_spec_dir_max=840"));
    assert!(DOC.contains(
