...
fn functional_r50_spec_volume_remediation_markers_present() {
    ...
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_baseline_spec_dirs=758"));
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_baseline_module_count=92"));
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_ratio_max=8.3"));
    assert!(DOC_R50.contains("r50_review_spec_volume_non_regression_spec_dir_max=758"));
    assert!(DOC_R50.contains(
...
fn functional_r52_post_publication_spec_volume_reduction_markers_present() {
    ...
    assert!(DOC_R52.contains("r52_review_spec_volume_reduction_tranche_pre_count=772"));
    assert!(DOC_R52.contains("r52_review_spec_volume_reduction_tranche_deleted_count=14"));
    assert!(DOC_R52.contains("r52_review_spec_volume_reduction_tranche_post_count=758"));
    assert!(DOC_R52
...
fn integration_r52_post_publication_spec_volume_reduction_markers_are_consistent() {
    ...
    assert_eq!(pre, 772, "tranche-7 pre-count marker should remain fixed");
    assert_eq!(
        deleted, 14,
        "tranche-7 deleted-count marker should remain fixed"
    );
    assert_eq!(
    ...
    assert_eq!(post, 758, "tranche-7 post-count marker should remain fixed");
    assert_eq!(
