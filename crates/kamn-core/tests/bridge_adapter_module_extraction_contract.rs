...
const ROOT: &str = "src/bridge_adapter.rs";
const ROOT_CAP: usize = 180;
const MODULE_CAP: usize = 200;
const MODULE_FILES: &[&str] = &[
    "src/bridge_adapter/models.rs",
    "src/bridge_adapter/engine.rs",
    "src/bridge_adapter/errors.rs",
    "src/bridge_adapter/support.rs",
    "src/bridge_adapter/tests.rs",
];
...
#[test]
fn bridge_adapter_root_is_extracted() {
