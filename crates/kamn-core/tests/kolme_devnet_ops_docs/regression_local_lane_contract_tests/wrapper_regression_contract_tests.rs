...
fn regression_requires_real_fork_local_process_wrapper_guard_marker() {
    assert_plan_contains_all(REGRESSION_REQUIRES_REAL_FORK_LOCAL_PROCESS_WRAPPER_GUARD_MARKER_PLAN_MARKERS, "regression_requires_real_fork_local_process_wrapper_guard_marker");
}
...
fn regression_requires_real_fork_wrapper_bootstrap_prerequisite_guard_marker() {
    assert_plan_contains_all(REGRESSION_REQUIRES_REAL_FORK_WRAPPER_BOOTSTRAP_PREREQUISITE_GUARD_MARKER_PLAN_MARKERS, "regression_requires_real_fork_wrapper_bootstrap_prerequisite_guard_marker");
}
...
fn regression_requires_real_fork_wrapper_policy_checker_guard_marker() {
    assert_plan_contains_all(REGRESSION_REQUIRES_REAL_FORK_WRAPPER_POLICY_CHECKER_GUARD_MARKER_PLAN_MARKERS, "regression_requires_real_fork_wrapper_policy_checker_guard_marker");
}
