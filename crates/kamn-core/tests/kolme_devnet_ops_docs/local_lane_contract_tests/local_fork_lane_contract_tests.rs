...
fn plan_contains_local_fork_sync_metadata_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_SYNC_METADATA_LANE_PLAN_MARKERS, "plan_contains_local_fork_sync_metadata_lane");
}
...
fn plan_contains_local_fork_smoke_evidence_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_SMOKE_EVIDENCE_LANE_PLAN_MARKERS, "plan_contains_local_fork_smoke_evidence_lane");
}
...
fn plan_contains_local_fork_bootstrap_readiness_contract_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_BOOTSTRAP_READINESS_CONTRACT_LANE_PLAN_MARKERS, "plan_contains_local_fork_bootstrap_readiness_contract_lane");
}
...
fn plan_contains_local_fork_process_lifecycle_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_PROCESS_LIFECYCLE_LANE_PLAN_MARKERS, "plan_contains_local_fork_process_lifecycle_lane");
}
...
fn plan_contains_local_fork_profile_preflight_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_PROFILE_PREFLIGHT_LANE_PLAN_MARKERS, "plan_contains_local_fork_profile_preflight_lane");
}
...
fn plan_contains_local_fork_self_test_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_SELF_TEST_LANE_PLAN_MARKERS, "plan_contains_local_fork_self_test_lane");
}
...
fn plan_contains_local_fork_portability_preflight_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_PORTABILITY_PREFLIGHT_LANE_PLAN_MARKERS, "plan_contains_local_fork_portability_preflight_lane");
}
...
fn plan_contains_local_fork_checkout_bootstrap_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_LOCAL_FORK_CHECKOUT_BOOTSTRAP_LANE_PLAN_MARKERS, "plan_contains_local_fork_checkout_bootstrap_lane");
}
...
fn plan_contains_real_fork_local_process_wrapper_lane() {
    assert_plan_contains_all(PLAN_CONTAINS_REAL_FORK_LOCAL_PROCESS_WRAPPER_LANE_PLAN_MARKERS, "plan_contains_real_fork_local_process_wrapper_lane");
}
...
fn plan_contains_real_fork_wrapper_policy_checker_test_command() {
    assert_plan_contains_all(PLAN_CONTAINS_REAL_FORK_WRAPPER_POLICY_CHECKER_TEST_COMMAND_PLAN_MARKERS, "plan_contains_real_fork_wrapper_policy_checker_test_command");
}
