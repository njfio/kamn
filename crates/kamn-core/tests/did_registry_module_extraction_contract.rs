...
const ROOT: &str = "src/did_registry.rs";
const ROOT_CAP: usize = 180;
const MODULE_CAP: usize = 200;
const MODULE_FILES: &[&str] = &[
    "src/did_registry/models.rs",
    "src/did_registry/validation.rs",
    "src/did_registry/store.rs",
    "src/did_registry/chain_submission.rs",
    "src/did_registry/lifecycle.rs",
    "src/did_registry/tests.rs",
];
...
#[test]
fn did_registry_root_is_extracted() {
