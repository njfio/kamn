...
const ROOT: &str = "tests/p2p_libp2p_native_adapter_runtime.rs";
...
const REQUIRED_FILES: &[&str] = &[
    "tests/p2p_libp2p_native_adapter_runtime/config_contract_tests.rs",
    "tests/p2p_libp2p_native_adapter_runtime/runtime_marker_contract_tests.rs",
    "tests/p2p_libp2p_native_adapter_runtime/discovery_gossip_contract_tests.rs",
    "tests/p2p_libp2p_native_adapter_runtime/partition_reason_contract_tests.rs",
    "tests/p2p_libp2p_native_adapter_runtime/performance_contract_tests.rs",
];

#[test]
fn p2p_libp2p_native_adapter_runtime_root_is_extracted() {
    let source = fs::read_to_string(ROOT).expect("root libp2p native adapter test file should be readable");
