...
fn local_kolme_lane_markers() -> &'static [&'static str] {
    &[
...
fn local_kolme_boundary_markers() -> &'static [&'static str] {
    &[
...
fn doc_contains_local_kolme_boundary_markers() {
    assert_doc_contains_all(local_kolme_boundary_markers(), "local kolme boundary");
}
