...
fn assert_governance_lib_declares_modules(governance_lib: &str) {
    for marker in [
...
fn assert_core_shims_reexport_governance_crate() {
...
fn assert_dashboards_remain_in_core() {
...
fn governance_phase1_contract_extracts_governance_primitives_and_keeps_dashboards_in_core() {
    ...
    assert_governance_lib_declares_modules(&governance_lib);
    assert_core_shims_reexport_governance_crate();
    assert_dashboards_remain_in_core();
}
