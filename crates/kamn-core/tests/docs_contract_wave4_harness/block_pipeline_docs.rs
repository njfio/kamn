...
fn regression_doc_tracks_transport_convergence_fault_matrix_markers() {
    // Regression: #3579
    assert_transport_convergence_core_markers();
    assert_transport_convergence_regression_markers();
    assert_transport_convergence_reason_taxonomy_markers();
}

fn assert_transport_convergence_core_markers() {
...
fn assert_transport_convergence_regression_markers() {
...
fn assert_transport_convergence_reason_taxonomy_markers() {
    assert!(DOC.contains(
