...
fn roadmap_contains_version_and_runtime_commit_contract_lane_commands() {
    assert_version_compatibility_markers();
    assert_runtime_commit_lane_markers();
    assert_nonce_and_notification_markers();
    assert_fixture_and_profile_markers();
}

fn assert_version_compatibility_markers() {
...
fn assert_runtime_commit_lane_markers() {
...
fn assert_nonce_and_notification_markers() {
...
fn assert_fixture_and_profile_markers() {
