...
{}",
    ...
    assert_eq!(u64_field(&report, "governance_commit_count"), 6);
    assert_eq!(u64_field(&report, "feature_commit_count"), 44);
    assert_eq!(f64_field(&report, "governance_ratio"), 0.12);
    assert_eq!(f64_field(&report, "feature_ratio"), 0.88);
