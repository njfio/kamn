...
{}",
    ...
    assert_eq!(u64_field(&report, "governance_commit_count"), 5);
    assert_eq!(u64_field(&report, "feature_commit_count"), 45);
    assert_eq!(f64_field(&report, "governance_ratio"), 0.1);
    assert_eq!(f64_field(&report, "feature_ratio"), 0.9);
