...
{}",
    ...
    assert_eq!(u64_field(&report, "governance_commit_count"), 9);
    assert_eq!(u64_field(&report, "feature_commit_count"), 41);
    assert_eq!(f64_field(&report, "governance_ratio"), 0.18);
    assert_eq!(f64_field(&report, "feature_ratio"), 0.82);
