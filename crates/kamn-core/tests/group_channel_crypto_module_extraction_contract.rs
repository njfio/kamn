...
const ROOT: &str = "src/group_channel_crypto.rs";
const ROOT_CAP: usize = 180;
const MODULE_CAP: usize = 200;
const MODULE_FILES: &[&str] = &[
    "src/group_channel_crypto/models.rs",
    "src/group_channel_crypto/engine.rs",
    "src/group_channel_crypto/errors.rs",
    "src/group_channel_crypto/validation.rs",
    "src/group_channel_crypto/crypto_helpers.rs",
    "src/group_channel_crypto/tests.rs",
];
...
#[test]
fn group_channel_crypto_root_is_extracted() {
