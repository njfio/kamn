...
fn spec_c03_reconcile_pending_and_final_finality_observation_projects_deterministic_updates() {
    ...
    let outcome = planned_outcome(&mut orchestrator, "00000000-0000-0000-0000-000000000501", "sha256:c03a");
...
fn spec_c04_reconcile_finality_observation_fails_closed_for_mismatch_and_missing_block_height() {
    let mut orchestrator = memory_orchestrator("kamn:did:agent:m1-orchestrator-c04-finality-fail", 1);
    let outcome = planned_outcome(&mut orchestrator, "00000000-0000-0000-0000-000000000601", "sha256:c04e");
    let submission = submission_metadata(&outcome);
