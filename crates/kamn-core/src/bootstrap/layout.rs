use super::models::{
    ...
    DID_REGISTRY_STORE_FILE_NAME,
    DURABLE_GUARD_STORE_COMPONENT_FILE, DURABLE_GUARD_STORE_COMPONENT_SQLITE,
    DURABLE_GUARD_STORE_FILE_NAME, MESSAGE_LIFECYCLE_SNAPSHOT_STORE_COMPONENT_FILE,
...
pub fn prioritized_runtime_store_components(store_adapter: &RuntimeStoreAdapter) -> [&'static str; 7] {
    match store_adapter {
