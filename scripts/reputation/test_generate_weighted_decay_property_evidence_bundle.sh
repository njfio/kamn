...
GENERATOR="$KAMN_ROOT/scripts/reputation/generate_weighted_decay_property_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/reputation/check_weighted_decay_property_policy.sh"
TMP_DIR="$(mktemp -d)"
