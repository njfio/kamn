...
GENERATOR="$KAMN_ROOT/scripts/governance/generate_stake_slash_risk_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/governance/check_stake_slash_risk_policy.sh"
TMP_DIR="$(mktemp -d)"
