...
GENERATOR="$KAMN_ROOT/scripts/governance/generate_governance_simulation_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/governance/check_governance_simulation_policy.sh"
TMP_DIR="$(mktemp -d)"
