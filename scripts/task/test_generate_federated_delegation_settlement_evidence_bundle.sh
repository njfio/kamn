...
GENERATOR="$KAMN_ROOT/scripts/task/generate_federated_delegation_settlement_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/task/check_federated_delegation_settlement_policy.sh"
TMP_DIR="$(mktemp -d)"
