...
resolve_manifest_name() {
  case "$1" in
    ...
    run_local_kolme_live_deployment_preflight_lane.sh) echo "kolme_local_kolme_live_deployment_preflight_lane.json" ;;
    ...
    run_onchain_lifecycle_evidence_bundle_lane.sh) echo "kolme_onchain_lifecycle_evidence_bundle_lane.json" ;;
