#!/usr/bin/env python3
"""Resolve non-Kolme wrapper metadata from manifest files."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Resolve non-Kolme wrapper manifest path and phase."
    )
    parser.add_argument(
        "--manifests-dir",
        required=True,
    ...
    parser.add_argument(
        "--wrapper-name",
        required=True,
        help="Wrapper file name, e.g. run_foo_contract_lane.sh.",
    )
