...
GENERATOR="$KAMN_ROOT/scripts/did/generate_lifecycle_operator_binding_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/did/check_lifecycle_operator_binding_policy.sh"
TMP_DIR="$(mktemp -d)"
