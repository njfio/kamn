...
GENERATOR="$KAMN_ROOT/scripts/signer/generate_secure_provider_key_lifecycle_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/signer/check_secure_provider_key_lifecycle_policy.sh"
TMP_DIR="$(mktemp -d)"
