...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local fork rust matrix script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_script_output" "test_scope")" "kolme-version-contract" "Kolme local fork rust matrix script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_test_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local fork rust matrix test script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_test_script_output" "test_scope")" "kolme-version-contract" "Kolme local fork rust matrix test script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local fork rust matrix policy script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_policy_script_output" "test_scope")" "kolme-version-contract" "Kolme local fork rust matrix policy script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local fork rust matrix contract lane script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_contract_lane_script_output" "test_scope")" "kolme-version-contract" "Kolme local fork rust matrix contract lane script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local fork rust matrix contract lane test script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_contract_lane_test_script_output" "test_scope")" "kolme-version-contract" "Kolme local fork rust matrix contract lane test script changes should set kolme-version-contract scope"
