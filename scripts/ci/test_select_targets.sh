...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local fork rust matrix script changes should stay out of fast-gate version compatibility routing"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local fork rust matrix test script changes should stay out of fast-gate version compatibility routing"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local fork rust matrix policy script changes should stay out of fast-gate version compatibility routing"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local fork rust matrix contract lane script changes should stay out of fast-gate version compatibility routing"
...
assert_eq "$(extract_output "$kolme_local_fork_rust_matrix_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local fork rust matrix contract lane test script changes should stay out of fast-gate version compatibility routing"
...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local runtime commit live script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local runtime commit live test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local runtime commit live evidence policy script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_finality_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local runtime commit live finality evidence contract lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_finality_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local runtime commit live finality evidence contract lane test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local native API parity live proof script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local native API parity live proof policy script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local native API parity live proof contract lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local native API parity live proof contract lane test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN live runtime integration lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN live runtime integration policy script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN live runtime integration contract lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN live runtime integration contract lane test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_real_node_profile_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN real-node profile policy script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_real_node_profile_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN real-node profile contract lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_real_node_profile_policy_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN real-node profile policy test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_real_node_profile_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local KAMN real-node profile contract lane test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_heavy_matrix_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local heavy matrix script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local bootstrap script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local bootstrap test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_checker_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local bootstrap checker script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_contract_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local bootstrap contract lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_checker_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local bootstrap checker test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_contract_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local bootstrap contract lane test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local E2E lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local E2E test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_checker_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local E2E policy checker changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_contract_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local E2E contract lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_checker_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local E2E policy checker test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_contract_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local E2E contract lane test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_heavy_matrix_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local heavy matrix test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_heavy_matrix_checker_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local heavy matrix checker script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_heavy_matrix_contract_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local heavy matrix contract lane script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_heavy_matrix_checker_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local heavy matrix checker test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_heavy_matrix_contract_test_script_output" "run_kolme_version_compatibility_contract_tests")" "false" "Kolme local heavy matrix contract lane test script changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$local_heavy_optin_helper_output" "run_kolme_version_compatibility_contract_tests")" "false" "Local-heavy opt-in helper changes should skip Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$local_heavy_optin_helper_test_output" "run_kolme_version_compatibility_contract_tests")" "false" "Local-heavy opt-in helper test changes should skip Kolme version compatibility contract lane"
