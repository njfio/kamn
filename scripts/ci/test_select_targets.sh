...
assert_eq "$(extract_output "$compliance_framework_helper_output" "run_governance_simulation_contract_tests")" "false" "contract lane helper changes should not run governance simulation lane"
assert_eq "$(extract_output "$compliance_framework_helper_output" "run_governance_stake_slash_contract_tests")" "false" "contract lane helper changes should not run governance stake/slash lane"
assert_eq "$(extract_output "$compliance_framework_helper_output" "run_reputation_dispute_contract_tests")" "false" "contract lane helper changes should not run reputation dispute lane"
