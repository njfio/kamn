...
assert_eq "$(extract_output "$kolme_local_bootstrap_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local bootstrap script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_script_output" "test_scope")" "kolme-version-contract" "Kolme local bootstrap script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_test_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local bootstrap test script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_bootstrap_test_script_output" "test_scope")" "kolme-version-contract" "Kolme local bootstrap test script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_e2e_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local E2E lane script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_script_output" "test_scope")" "kolme-version-contract" "Kolme local E2E lane script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_e2e_test_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local E2E test script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_e2e_test_script_output" "test_scope")" "kolme-version-contract" "Kolme local E2E test script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$local_heavy_optin_helper_output" "run_kolme_version_compatibility_contract_tests")" "true" "Local-heavy opt-in helper changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$local_heavy_optin_helper_output" "test_scope")" "kolme-version-contract" "Local-heavy opt-in helper changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$local_heavy_optin_helper_test_output" "run_kolme_version_compatibility_contract_tests")" "true" "Local-heavy opt-in helper test changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$local_heavy_optin_helper_test_output" "test_scope")" "kolme-version-contract" "Local-heavy opt-in helper test changes should set kolme-version-contract scope"
