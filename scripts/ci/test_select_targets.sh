...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local runtime commit live script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_script_output" "test_scope")" "kolme-version-contract" "Kolme local runtime commit live script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_runtime_commit_live_test_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local runtime commit live test script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local native API parity live proof script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_script_output" "test_scope")" "kolme-version-contract" "Kolme local native API parity live proof script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local native API parity live proof policy script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_policy_script_output" "test_scope")" "kolme-version-contract" "Kolme local native API parity live proof policy script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local native API parity live proof contract lane script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_contract_lane_script_output" "test_scope")" "kolme-version-contract" "Kolme local native API parity live proof contract lane script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_native_api_parity_live_proof_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local native API parity live proof contract lane test script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local KAMN live runtime integration lane script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_lane_script_output" "test_scope")" "kolme-version-contract" "Kolme local KAMN live runtime integration lane script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_policy_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local KAMN live runtime integration policy script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_policy_script_output" "test_scope")" "kolme-version-contract" "Kolme local KAMN live runtime integration policy script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_contract_lane_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local KAMN live runtime integration contract lane script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_contract_lane_script_output" "test_scope")" "kolme-version-contract" "Kolme local KAMN live runtime integration contract lane script changes should set kolme-version-contract scope"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_contract_lane_test_script_output" "run_kolme_version_compatibility_contract_tests")" "true" "Kolme local KAMN live runtime integration contract lane test script changes must run Kolme version compatibility contract lane"
...
assert_eq "$(extract_output "$kolme_local_kamn_live_runtime_integration_contract_lane_test_script_output" "test_scope")" "kolme-version-contract" "Kolme local KAMN live runtime integration contract lane test script changes should set kolme-version-contract scope"
