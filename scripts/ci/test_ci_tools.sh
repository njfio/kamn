...
if [ "${KAMN_CI_TOOLS_FAST_MODE:-false}" = "true" ]; then
  ...
  bash "$ROOT_DIR/scripts/ci/test_check_workflow_kolme_heavy_exclusion_policy.sh"
  ...
  bash "$ROOT_DIR/scripts/ci/test_block_reconciliation_partition_rejoin_ci_exclusion_policy.sh"
