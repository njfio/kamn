...
required_commands=(
  ...
  'bash "$ROOT_DIR/scripts/ci/test_local_metrics_scrape_ci_exclusion_policy.sh"'
  'bash "$ROOT_DIR/scripts/ci/test_local_observability_scrape_ci_exclusion_policy.sh"'
  'bash "$ROOT_DIR/scripts/ci/test_service_api_serde_payload_parity_ci_exclusion_policy.sh"'
  'bash "$ROOT_DIR/scripts/ci/test_service_api_reason_code_compatibility_ci_exclusion_policy.sh"'
  'bash "$ROOT_DIR/scripts/ci/test_service_api_validation_negative_matrix_ci_exclusion_policy.sh"'
  ...
  'bash "$ROOT_DIR/scripts/runtime/test_validate_libp2p_process_isolated_harness.sh"'
