...
usage() {
  cat >&2 <<'USAGE'
Usage: test_check_non_kolme_wave_wrapper_family_budget_trend_impl.sh --wave-id <id>
USAGE
}
...
TREND_CHECKER="$ROOT_DIR/scripts/ci/check_non_kolme_wave${WAVE_ID}_wrapper_family_budget_trend.sh"
