...
if ! grep -Fq "GOVERNANCE_FEATURE_COMMIT_RATIO_MORATORIUM_BASE_SHA=0cb56974454e79789d594a7b8222060b9f3a9b95" "$ROOT_DIR/.ci/governance-feature-commit-ratio-moratorium.env"; then
