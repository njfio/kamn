...
HARNESS_SCENARIOS: list[tuple[str, int, list[str]]] = [
    ...
    (
        ...
        [
            ...
            "--test",
            "p2p_libp2p_native_adapter_runtime",
            "integration_libp2p_native_adapter_three_node_partition_rejoin_and_publish_drop_convergence_over_sockets",
            "--",
            "--exact",
        ],
    ),
    (
        ...
        [
            ...
            "--test",
            "p2p_libp2p_native_adapter_runtime",
            "regression_libp2p_native_adapter_partition_publish_drop_reason_code_stays_stable",
            "--",
            "--exact",
        ],
    ),
