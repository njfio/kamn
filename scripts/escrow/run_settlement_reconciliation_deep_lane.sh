...
RACE_MATRIX_RUNNER="$ROOT_DIR/scripts/escrow/run_settlement_reconciliation_race_matrix.py"
RACE_FIXTURE="$ROOT_DIR/fixtures/escrow_reconciliation/finality_race_cases.json"
...
no_go_bundle="$TMP_DIR/settlement-deep-no-go.json"
