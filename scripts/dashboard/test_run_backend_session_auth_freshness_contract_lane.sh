...
test_harness_require_executable "$SCRIPT" "expected dashboard backend session/auth freshness contract lane script to be executable"
test_harness_require_executable "$SHARED_CONTRACT" "expected dashboard backend session/auth freshness shared contract-lane module to be executable"
test_harness_require_file "$MANIFEST" "expected dashboard backend session/auth freshness manifest to exist"
