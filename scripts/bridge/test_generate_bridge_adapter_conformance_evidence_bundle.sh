...
GENERATOR="$KAMN_ROOT/scripts/bridge/generate_bridge_adapter_conformance_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/bridge/check_bridge_adapter_conformance_policy.sh"
TMP_DIR="$(mktemp -d)"
