...
GENERATOR="$KAMN_ROOT/scripts/bridge/generate_cross_chain_outbound_intent_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/bridge/check_cross_chain_outbound_intent_policy.sh"
TMP_DIR="$(mktemp -d)"
