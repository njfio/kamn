...
GENERATOR="$KAMN_ROOT/scripts/canary/generate_post_cutover_slo_evidence_bundle.sh"
POLICY_CHECKER="$KAMN_ROOT/scripts/canary/check_post_cutover_slo_policy.sh"
TMP_DIR="$(mktemp -d)"
