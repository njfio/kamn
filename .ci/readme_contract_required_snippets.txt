# README contract required snippets for Rust lane
# One literal marker per line; blank lines and lines starting with # are ignored.
cargo fmt --check
...
run_local_kolme_live_deployment_preflight_lane.sh --mode dry-run
