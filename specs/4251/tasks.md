...
- T3 (Integration): enforce mapping markers in contract lane checks.
- T4 (Docs/Conformance): update strategy/ops/checklist docs and docs contract assertions.
- T5 (Verification): run runtime lane tests + docs contract tests + fmt gate.
