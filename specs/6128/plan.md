...
## Approach
1. Re-state `S-05` behavior contract and impacted modules from issue #6128.
...
## Affected Modules
- Target module(s) identified by issue #6128 scope and test evidence.
- `specs/6128/spec.md`
- `specs/6128/plan.md`
- `specs/6128/tasks.md`

## Risks / Mitigations
- Risk: Scope expansion beyond `S-05` causes unnecessary churn.
...
- Preserve existing public interfaces unless change is explicitly required by `S-05` acceptance criteria.
