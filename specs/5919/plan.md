# Plan: Issue #5919 - Story: Architecture and Sustainability Remediation

- Issue: #5919
- Spec: `specs/5919/spec.md`
- Status: Draft
- Last Updated: 2026-02-24

## Approach
1. RED: Add/extend failing tests for conformance cases defined in specs/5919/spec.md.
2. Implement: Decompose kamn-core, reduce shell/python surface, eliminate duplication, and wire data layers.
...
- Primary contract source: `specs/5919/spec.md`.
- Upstream issue contract: GitHub issue #5919.
