...
- Title: Task: integrate shutdown evidence requirements into release go/no-go gate
- Parent: #3823
...
- C-03 (AC-1/AC-2): 'bash scripts/runtime/test_run_lifecycle_property_contract_lane.sh' passes.
