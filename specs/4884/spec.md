...
- Title: Subtask: implement shell-rust telemetry collector with deterministic reason taxonomy outputs
- Parent: - Parent task: #4870
...
Extend telemetry reporting for shell/rust LOC trend and ratchet reason outputs.
...
- AC-1: Telemetry collector emits stable key/value outputs and reason taxonomy versions.
- AC-2: Policy checker produces deterministic failure reasons for all threshold violations.
