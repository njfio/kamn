...
- Title: Subtask: consolidate CI wave budget trend duplicate scripts into shared checker
...
Replace repeated CI wave budget trend scripts with shared parameterized checker flow.
...
- AC-1: CI wave budget scripts collapse to single checker path plus config definitions.
- AC-2: Policy reasons and telemetry keys remain deterministic.
