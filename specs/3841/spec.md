...
- Title: Task: enforce runtime.rs line-count trend budget policy and threshold telemetry
- Parent: #3837
...
- C-01 (AC-1/AC-2): 'bash scripts/ci/test_check_kamn_node_runtime_orchestration_rs_extraction_threshold.sh' passes.
- C-02 (AC-1/AC-2): 'cargo test -p kamn-core --test runtime_module_extraction_contract' passes.
- C-03 (AC-1/AC-2): 'bash scripts/runtime/test_run_runtime_snapshot_contract_lane.sh' passes.
