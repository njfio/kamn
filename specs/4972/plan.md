...
- Limit scope strictly to issue #4972 boundaries.

## Affected Modules
- To be finalized in implementation branch for #4972.
...
## ADR
- Open ADR only if issue #4972 introduces architecture/dependency/protocol changes.
