...
- Title: Subtask: consolidate framework wave wrapper matrix scripts into parameterized runner
- Parent: - Parent task: #4866
...
Create definition-driven framework runner replacing duplicated wave wrapper scripts.
...
- AC-1: Wave runner accepts parameterized definitions for existing wave families.
- AC-2: Regression tests confirm parity between old and new wave outputs.
