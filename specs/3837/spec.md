...
- Title: Story: enforce runtime module ownership contracts and anti-regrowth budget governance
- Parent: #3814
...
- C-03 (AC-1/AC-2): 'bash scripts/ci/test_check_kamn_node_runtime_orchestration_rs_extraction_threshold.sh' passes.
