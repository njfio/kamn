...
## Approach
- Implement issue #4969 using Red -> Green -> Refactor -> Regression loop.
- Keep shell-surface and process-contract outputs deterministic and fail closed.
- Limit scope strictly to issue #4969 boundaries.

## Affected Modules
- To be finalized in implementation branch for #4969.
...
## ADR
- Open ADR only if issue #4969 introduces architecture/dependency/protocol changes.
