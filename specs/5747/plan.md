# Plan: #5747 Execute R52 Spec-Volume Remediation Tranche-12 (14-Dir Reduction)

## Approach
1. RED: update existing docs-contract expectations to tranche-12 values and capture failing run.
...
4. Refresh R50 + R52 review markers to tranche-12 values.
