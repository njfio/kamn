...
- Title: Subtask: wire downward-only threshold ratchets into fast-gate policy checks
...
Apply ratcheting threshold rules and enforce bounded exceptions with explicit governance paths.
...
- AC-1: Fast-gate blocks threshold regressions according to ratchet policy.
- AC-2: Exceptions require linked mitigation issue and explicit reason markers.
