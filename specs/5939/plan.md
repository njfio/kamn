# Plan: Issue #5939 - Task: Expand mutation and coverage gates (llvm-cov) for critical runtime/security paths
...
2. Implement: Broaden mutation scope and add enforceable coverage reporting for critical crates.
...
- Primary contract source: `specs/5939/spec.md`.
- Upstream issue contract: GitHub issue #5939.
