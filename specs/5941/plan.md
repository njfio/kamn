# Plan: Issue #5941 - Task: Add cargo-audit dependency vulnerability scanning to required CI gates
...
2. Implement: Integrate cargo-audit into required CI with waiver policy and deterministic reporting.
...
- Primary contract source: `specs/5941/spec.md`.
- Upstream issue contract: GitHub issue #5941.
