# Plan: Issue #5940 - Task: Deepen crypto and data-layer module test depth (M6-M11 + DM/Group crypto)
...
## Approach
1. RED: Add/extend failing tests for conformance cases defined in specs/5940/spec.md.
2. Implement: Add comprehensive positive/negative/edge-case test suites for DM/group crypto and M6-M11 modules.
...
- `crates/kamn-core/src/data_layer_m6.rs` to `crates/kamn-core/src/data_layer_m11.rs`
...
- Primary contract source: `specs/5940/spec.md`.
- Upstream issue contract: GitHub issue #5940.
