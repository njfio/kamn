# Issue #5604 Tasks - PRD Phase-6 Runtime External Lifecycle Execution

## Ordered Tasks
1. T1 (tests/red): add failing conformance tests for runtime lifecycle transition markers.
2. T2 (impl/green): implement deterministic runtime lifecycle transition marker composition.
3. T3 (docs/green): add runtime lifecycle docs marker artifact + milestone update.
...
## Test Tier Mapping
- Functional: runtime lifecycle transition marker behavior.
