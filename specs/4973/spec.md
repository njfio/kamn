...
## Problem Statement
Issue #4973 is part of the R27.44 shell maintainability tranche and closes one portion of the deletion-wave, spec-archival, and hard-ceiling governance gap.

## Acceptance Criteria
- AC-1: Scope defined in GitHub issue #4973 is implemented and verified.
...
## Scope
In scope:
- Work explicitly described in issue #4973.
...
|---|---|---|---|---|
| C-01 | AC-1 | Functional | Execute scoped workflow for #4973 | Behavior matches issue acceptance criteria |
...
## Test Mapping
- To be completed during implementation for issue #4973.

## Success Metrics
- All ACs for #4973 are mapped to conformance cases and passing tests.
- No shell-surface governance regressions introduced by #4973.
