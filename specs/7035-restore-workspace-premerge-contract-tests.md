...
- Continued Fast Gate repair commits may shift the 50-commit governance evidence
  ...
  passing checker output (`4` governance, `46` feature, ratio `0.08`) while
...
`cf67381783f4aa68f143ec6436def247d521abfe` local governance-window refresh:

```bash
python3 scripts/ci/check_governance_feature_commit_ratio.py --repo-root . --base-sha d2c2fe1b901a1d53ea419f31778e1d836f2b1323 --head-sha HEAD --window-size 50 --max-governance-ratio 0.20 --output-json /tmp/kamn-governance-ratio-current-head-post-cf673817-after-patch.json
# status=ok
# governance_commit_count=4
# feature_commit_count=46
...
bash scripts/ci/check_touched_rust_size_policy.sh --base-ref main --threshold-file fixtures/ci/touched_rust_size_policy_thresholds.json --baseline-file fixtures/ci/touched_rust_size_policy_baseline.json --output-json /tmp/kamn-touched-rust-size-policy-7035-governance-current-head-post-cf673817.json
# status=pass
# policy_decision=GO
# offending_files=none
# offending_functions=none
