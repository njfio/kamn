...
## Approach
1. Re-state `S-04` behavior contract and impacted modules from issue #6127.
...
## Affected Modules
- Target module(s) identified by issue #6127 scope and test evidence.
- `specs/6127/spec.md`
- `specs/6127/plan.md`
- `specs/6127/tasks.md`

## Risks / Mitigations
- Risk: Scope expansion beyond `S-04` causes unnecessary churn.
...
- Preserve existing public interfaces unless change is explicitly required by `S-04` acceptance criteria.
