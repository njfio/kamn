...
- Title: Subtask: retire manual manifest maintenance path and enforce registry drift contracts
...
Remove manual artifact maintenance for targeted lanes and enforce drift checks in CI.
...
- AC-1: Drift contracts fail closed if generated artifacts are stale.
- AC-2: Manual path is gated or removed for migrated lanes.
