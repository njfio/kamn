# Plan: Issue #5921 - Task: Implement production DirectMessage/GroupChannel encryption (X25519 + XChaCha20-Poly1305)
...
2. Implement: Implement canonical key agreement + AEAD paths; mark deterministic fixtures test-only.
...
- Primary contract source: `specs/5921/spec.md`.
- Upstream issue contract: GitHub issue #5921.
