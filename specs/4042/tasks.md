...
- [x] T2 (GREEN): implement schema-compatibility fixture parser + run-lane deterministic report projection (`C-01`, `C-02`).
...
- [x] T5 (GREEN): update strategy/ops docs and docs-contract assertions for marker parity (`C-05`).
...
| Functional | compatible/incompatible pair evaluation + policy pass/fail |
