# Plan: Issue #5927 - Task: Replace synthetic daemon tick loop behavior with real queue processing
...
- `crates/kamn-node/src/daemon_supervisor.rs`
...
- Primary contract source: `specs/5927/spec.md`.
- Upstream issue contract: GitHub issue #5927.
