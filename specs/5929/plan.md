# Plan: Issue #5929 - Task: Harden SDK HTTP request construction against path/header injection
...
- Primary contract source: `specs/5929/spec.md`.
- Upstream issue contract: GitHub issue #5929.
