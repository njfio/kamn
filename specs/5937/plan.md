# Plan: Issue #5937 - Task: Add async and real HTTP/WebSocket/TLS integration coverage for service/runtime
...
2. Implement: Add async runtime tests plus HTTP, websocket, and TLS integration suites with real servers.
...
- Primary contract source: `specs/5937/spec.md`.
- Upstream issue contract: GitHub issue #5937.
