...
## Approach
1. Re-state `S-14` behavior contract and impacted modules from issue #6137.
...
## Affected Modules
- Target module(s) identified by issue #6137 scope and test evidence.
- `specs/6137/spec.md`
- `specs/6137/plan.md`
- `specs/6137/tasks.md`

## Risks / Mitigations
- Risk: Scope expansion beyond `S-14` causes unnecessary churn.
...
- Preserve existing public interfaces unless change is explicitly required by `S-14` acceptance criteria.
