...
## Problem Statement
Implement runtime liveness health checks during daemon execution, not only at startup.

## Scope
In scope:
- Implement targeted remediation for `X-05` from `docs/review/gaps-and-issues-r59-swarm.md`.
...
Out of scope:
- Unrelated refactors outside `X-05`.
...
## Acceptance Criteria
- AC-1: The X-05 gap is remediated with production-safe behavior.
...
## Conformance Cases
- C-01 (Conformance, AC-1): Implemented behavior resolves R59 X-05 with deterministic pass/fail signals.
