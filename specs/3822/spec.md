...
- Title: Subtask: add policy checker for shutdown markers, CI exclusion, and runtime budget thresholds
- Parent: #3820
...
- C-01 (AC-1/AC-2): 'bash scripts/runtime/test_check_local_signal_secret_hygiene_live_policy.sh' passes.
- C-02 (AC-1/AC-2): 'bash scripts/runtime/test_validate_local_signal_secret_hygiene_live_contract_lane.sh' passes.
- C-03 (AC-1/AC-2): 'bash scripts/ci/test_local_signal_secret_hygiene_ci_exclusion_policy.sh' passes.
