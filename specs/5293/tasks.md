...
- [x] T1 (Red): add failing conformance tests for scheduler trigger decision precedence, deferred cycle no-op behavior, preflight budget overflow fail-closed path, and triggered cycle integration (`C-01`..`C-06`).
- [x] T2 (Green): implement Phase-6 scheduler trigger policy/signal/decision contracts and evaluator with deterministic reason markers (`C-01`..`C-03`).
