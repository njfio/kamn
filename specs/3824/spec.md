...
- Title: Task: publish shutdown operator runbook with deterministic checkpoint markers
- Parent: #3823
...
- C-02 (AC-1/AC-2): 'bash scripts/runtime/test_validate_service_api_graceful_shutdown_drain_live_contract_lane.sh' passes.
- C-03 (AC-1/AC-2): 'bash scripts/runtime/test_check_service_api_shutdown_abrupt_close_regression_live_policy.sh' passes.
- C-04 (AC-1/AC-2): 'bash scripts/runtime/test_validate_service_api_shutdown_abrupt_close_regression_live_contract_lane.sh' passes.
