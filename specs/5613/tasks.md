# Issue #5613 Tasks - External Preflight Rejects Non-File Binary Paths

## Ordered Tasks
1. T1 (tests/red): add failing conformance tests for non-file path rejection and pass-path behavior.
2. T2 (impl/green): implement regular-file checks in preflight with deterministic diagnostics.
3. T3 (docs/green): add R52 non-file diagnostics docs artifact + milestone index updates.
...
## Test Tier Mapping
- Functional: non-file-path preflight diagnostics behavior.
