...
- T3 (Integration): project new markers in convergence contract lane JSON/stdout and enforce parity checks.
- T4 (Docs): update strategy/runbook/release checklist and corresponding doc contract tests.
