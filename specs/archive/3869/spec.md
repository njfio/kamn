...
- Title: Story: validate libp2p recovery semantics and peer-lifecycle fail-closed behavior
- Parent: #3862
...
- C-03 (AC-1/AC-2): bash scripts/deploy/test_run_gonogo_evidence_contract_lane.sh passes.
