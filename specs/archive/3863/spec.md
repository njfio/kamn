...
- Title: Story: expand live libp2p churn-partition convergence matrix and deterministic evidence
- Parent: #3862
...
- C-03 (AC-1/AC-2): bash scripts/ci/test_libp2p_convergence_process_isolated_ci_exclusion_policy.sh passes.
