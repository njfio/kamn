...
## Approach
- Implement issue #4967 using Red -> Green -> Refactor -> Regression loop.
- Keep shell-surface and process-contract outputs deterministic and fail closed.
- Limit scope strictly to issue #4967 boundaries.

## Affected Modules
- To be finalized in implementation branch for #4967.
...
## ADR
- Open ADR only if issue #4967 introduces architecture/dependency/protocol changes.
