...
- Title: Task: enforce libp2p convergence policy drift guards and CI cost boundaries
- Parent: #3863
...
- C-03 (AC-1/AC-2): bash scripts/runtime/test_check_libp2p_convergence_process_isolated_live_policy.sh passes.
