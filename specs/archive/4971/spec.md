...
## Problem Statement
Issue #4971 is part of the R27.44 shell maintainability tranche and closes one portion of the deletion-wave, spec-archival, and hard-ceiling governance gap.

## Acceptance Criteria
- AC-1: Scope defined in GitHub issue #4971 is implemented and verified.
...
## Scope
In scope:
- Work explicitly described in issue #4971.
...
|---|---|---|---|---|
| C-01 | AC-1 | Functional | Execute scoped workflow for #4971 | Behavior matches issue acceptance criteria |
...
- No shell-surface governance regressions introduced by #4971.
