...
- Title: Subtask: add failed-handshake and backoff scenario harness for recovery matrix lanes
- Parent: #3870
...
- C-01 (AC-1/AC-2): bash scripts/runtime/test_validate_libp2p_process_isolated_harness_contract_lane.sh passes.
- C-02 (AC-1/AC-2): bash scripts/runtime/test_check_libp2p_three_node_discovery_live_policy.sh passes.
