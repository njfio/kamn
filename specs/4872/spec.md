...
- Title: Subtask: implement common.sh primitives and migrate pilot script families
...
Create/extend common shell primitives and migrate first wave of high-duplication scripts.
...
- AC-1: Pilot migration validates common helper parity and deterministic outputs.
- AC-2: Migration telemetry captures helper dedup impact and no contract drift.
