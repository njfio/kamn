...
## Approach
- Implement issue #4976 using Red -> Green -> Refactor -> Regression loop.
- Keep shell-surface and process-contract outputs deterministic and fail closed.
- Limit scope strictly to issue #4976 boundaries.

## Affected Modules
- To be finalized in implementation branch for #4976.
...
## ADR
- Open ADR only if issue #4976 introduces architecture/dependency/protocol changes.
