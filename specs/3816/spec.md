...
- Title: Story: implement real OS signal handling and graceful runtime shutdown orchestration
- Parent: #3813
...
- C-04 (AC-1/AC-2): 'bash scripts/runtime/test_validate_local_signal_secret_hygiene_live_contract_lane.sh' passes.
