...
- [x] T2 (Green): deliver stable contract behavior for mapped libp2p suites.
...
- `bash scripts/runtime/test_check_libp2p_process_isolated_harness_policy.sh`
- `bash scripts/runtime/test_validate_libp2p_process_isolated_harness_contract_lane.sh`
