...
## Approach
- Implement issue #4978 using Red -> Green -> Refactor -> Regression loop.
- Keep shell-surface and process-contract outputs deterministic and fail closed.
- Limit scope strictly to issue #4978 boundaries.

## Affected Modules
- To be finalized in implementation branch for #4978.
...
## ADR
- Open ADR only if issue #4978 introduces architecture/dependency/protocol changes.
