...
## Approach
1. Re-state `S-01` behavior contract and impacted modules from issue #6124.
...
## Risks / Mitigations
- Risk: Scope expansion beyond `S-01` causes unnecessary churn.
...
- Preserve existing public interfaces unless change is explicitly required by `S-01` acceptance criteria.
