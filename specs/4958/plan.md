...
## Approach
- Implement issue #4958 using Red -> Green -> Refactor -> Regression loop.
- Keep shell-surface and process-contract outputs deterministic and fail closed.
- Limit scope strictly to issue #4958 boundaries.

## Affected Modules
- To be finalized in implementation branch for #4958.
...
## ADR
- Open ADR only if issue #4958 introduces architecture/dependency/protocol changes.
