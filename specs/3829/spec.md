...
- Title: Subtask: add release checklist template entries for shutdown validation evidence
- Parent: #3827
...
- C-02 (AC-1/AC-2): 'bash scripts/runtime/test_run_lifecycle_property_contract_lane.sh' passes.
