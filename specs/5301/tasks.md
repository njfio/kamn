...
- [x] T1 (Red): add failing daemon/report/docs conformance tests for convergence marker projection (`C-01`..`C-05`).
- [x] T2 (Green): implement deterministic convergence projection helper with fail-closed decision markers (`C-01`..`C-03`).
