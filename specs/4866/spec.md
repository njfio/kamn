...
Collapse duplicated wave/matrix script families into parameterized runners with explicit fixtures.
...
- AC-1: Wave/matrix duplicate scripts are replaced by parameterized execution paths.
- AC-2: Regression coverage proves parity between old and new paths.
- AC-3: Script LOC for targeted families decreases with telemetry evidence.
