...
- Title: Task: update runtime ownership docs and add module-boundary contract tests
- Parent: #3837
...
- C-03 (AC-1/AC-2): 'cargo test -p kamn-core --test runtime_module_extraction_contract' passes.
