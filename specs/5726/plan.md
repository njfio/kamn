# Plan: #5726 Execute R52 Spec-Volume Remediation Tranche-5 (14-Dir Reduction)

## Approach
1. RED: update existing docs-contract expectations to tranche-5 values and capture failing run.
...
4. Refresh R50 + R52 review markers to tranche-5 values.
