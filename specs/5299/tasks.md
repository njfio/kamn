...
- [x] T1 (Red): add failing daemon/report/docs conformance tests for applied/deferred/fail-closed Phase-6 runtime markers (`C-01`..`C-04`).
- [x] T2 (Green): implement daemon Phase-6 scheduler runtime integration helper and deterministic fixture path (`C-01`..`C-03`).
