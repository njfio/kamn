...
- Title: Subtask: add manifest wrapper_name/phase metadata and rewrite dispatcher resolution
...
Extend manifests with wrapper/phase metadata and replace hardcoded dispatcher case blocks.
...
- AC-1: Dispatcher resolves lane mapping from manifest metadata/index.
- AC-2: Fallback behavior emits deterministic reason taxonomy markers on misses.
