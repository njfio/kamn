...
- Title: Subtask: add convergence profile fixtures and topology matrix runner wiring
- Parent: #3864
...
- C-01 (AC-1/AC-2): bash scripts/runtime/test_validate_libp2p_convergence_process_isolated_live_contract_lane.sh passes.
- C-02 (AC-1/AC-2): bash scripts/runtime/test_validate_libp2p_three_node_discovery_live_contract_lane.sh passes.
